...
const filters = {'companyDropdown':['KPMG','Deloitte','EY','PwC'],'roleDropdown':['Internship','Graduate'],'disciplineDropdown':['Comp Science','Finance','Marketing','Engineering'],'industryDropdown':['Consulting','Audit','AI','Digital'],'topicDropdown':['Interviews','Assessments','Applications']}
